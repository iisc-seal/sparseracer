...
define i32 @main() #0 {
  ...
  %3 = bitcast i8* %2 to %struct.node*, !dbg !53
  store %struct.node* %3, %struct.node** %head, align 8, !dbg !53
  %4 = load %struct.node** %head, align 8, !dbg !54
  %5 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([12 x i8]* @.str, i32 0, i32 0), %struct.node* %4), !dbg !54
  %6 = load %struct.node** %head, align 8, !dbg !55
  %7 = bitcast %struct.node* %6 to i8*, !dbg !55
  call void @free(i8* %7) #6, !dbg !55
  call void @llvm.dbg.declare(metadata !{i32** %a}, metadata !56), !dbg !58
  %8 = call noalias i8* @_Znwm(i64 4) #7, !dbg !58
  %9 = bitcast i8* %8 to i32*, !dbg !58
  store i32* %9, i32** %a, align 8, !dbg !58
  %10 = load i32** %a, align 8, !dbg !59
  %11 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([9 x i8]* @.str1, i32 0, i32 0), i32* %10), !dbg !59
  %12 = load i32** %a, align 8, !dbg !60
  %13 = icmp eq i32* %12, null, !dbg !60
  br i1 %13, label %16, label %14, !dbg !60

; <label>:14                                      ; preds = %0
  %15 = bitcast i32* %12 to i8*, !dbg !61
  call void @_ZdlPv(i8* %15) #8, !dbg !61
  br label %16, !dbg !61

; <label>:16                                      ; preds = %14, %0
  call void @llvm.dbg.declare(metadata !{i32** %array}, metadata !63), !dbg !64
  %17 = call noalias i8* @_Znam(i64 40) #7, !dbg !64
  %18 = bitcast i8* %17 to i32*, !dbg !64
  store i32* %18, i32** %array, align 8, !dbg !64
  %19 = load i32** %array, align 8, !dbg !65
  %20 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([13 x i8]* @.str2, i32 0, i32 0), i32* %19), !dbg !65
  %21 = load i32** %array, align 8, !dbg !66
  %22 = icmp eq i32* %21, null, !dbg !66
  br i1 %22, label %25, label %23, !dbg !66

; <label>:23                                      ; preds = %16
  %24 = bitcast i32* %21 to i8*, !dbg !67
  call void @_ZdaPv(i8* %24) #8, !dbg !67
  br label %25, !dbg !67

; <label>:25                                      ; preds = %23, %16
  %26 = load i32* %1, !dbg !69
  ret i32 %26, !dbg !69
}
